...
- **Explanation**: An object in JavaScript is a collection of key-value pairs. Each key (also known as a property) is a unique identifier, and the value can be anything: a string, number, array, function, or even another object.
- **Example**:
  ```javascript
  const myObject = {
...
### Theory
DOM is a programming interface for HTML and XML documents. It represents the document as a tree structure where each node is an object representing a part of the document.

### 1. DOM Selection Methods
#### a) document.getElementById()
- **Theory**: Selects an element by its ID attribute
- **Example**:
  ```html
...
- **Theory**: Returns a collection of elements with the specified class name
- **Example**:
  ```html
...
- **Theory**: Returns a collection of elements with the specified tag name
- **Example**:
  ```javascript
...
- **Theory**: Returns the first element that matches the CSS selector
- **Example**:
  ```javascript
...
- **Theory**: Returns all elements that match the CSS selector
- **Example**:
  ```javascript
...
### 2. DOM Properties
#### a) innerText
- **Theory**: Gets or sets the text content of an element
- **Example**:
  ```javascript
...
#### b) innerHTML
- **Theory**: Gets or sets the HTML content of an element
- **Example**:
  ```javascript
...
#### c) textContent
- **Theory**: Gets or sets the text content of a node and its descendants
- **Example**:
  ```javascript
...
#### d) style
- **Theory**: Gets or sets inline styles of an element
- **Example**:
  ```javascript
...
- **Theory**: Events are actions that occur in a web page that can be detected by JavaScript
- **Example**:
  ```javascript
  // Click event
...
### 4. Error Handling
- **Theory**: Try-catch blocks are used to handle errors gracefully
- **Example**:
  ```javascript
  try {
...
- **Theory**: You can throw custom errors using the throw statement
- **Example**:
  ```javascript
  function divide(a, b) {
      if (b === 0) {
...
### 6. Promises
- **Theory**: Promises are used for handling asynchronous operations
- **Example**:
  ```javascript
  const myPromise = new Promise((resolve, reject) => {
      // Async operation
...
2. **Example**
   ```javascript
   const numbers = [1, 2, 3]; 
   const moreNumbers = numbers;  // moreNumbers now references the same array as numbers 
...
2. **Example**
   ...
   console.log(originalArray); 
   // Output: [{ id: 1, name: 'Alice' }, { id: 2, name: 'Robert' }, { id: 3, name: 'Charlie' }] 
