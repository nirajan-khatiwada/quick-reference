---
title: "Scroll Trigger Animations: whileInView & viewport"
slug: "scroll-trigger-animations-whileinview"
date: 2025-10-20
description: "Trigger animations on scroll without complex setup. Master the `whileInView` and `viewport` props in Framer Motion."
showToc: true
weight: 9
series: ["Framer Motion"]
categories: ["Framer Motion", "React"]
tags: ["Framer Motion", "React", "Animation", "Scroll", "whileInView", "Intersection Observer"]
summary: "Easily trigger animations when elements enter the viewport using `whileInView`. Configure offsets and repeat behavior."
